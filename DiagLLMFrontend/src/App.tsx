            ...
            <Box pb={'5%'}>
                ...
                <Box pl={'15%'} mt={'5%'}>
                    ...
                    <Box maxWidth={'75%'} mt={5}>
                        ...
                        />
                        <Button variant="contained" sx={{mt: 2}} onClick={handleQuery}>Get Answer</Button>
                    </Box>
                </Box>
            </Box>
